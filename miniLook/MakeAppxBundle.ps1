...
$folderNames = @()
$folderNames += "miniLook_" + $largestVersion + "_x64_Test"
$folderNames += "miniLook_" + $largestVersion + "_x86_Test"
$folderNames += "miniLook_" + $largestVersion + "_arm64_Test"
...
$bundleName = "${currentPath}\${trimmedMsixesFolder}\miniLook_${largestVersion}.msixbundle"
